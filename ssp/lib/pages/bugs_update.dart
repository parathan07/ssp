...
class BugsUpdatePage extends StatefulWidget
{
  final String data;
  BugsUpdatePage({Key? key, required this.data}) : super(key: key);
...
class _MyHomePageState extends State<BugsUpdatePage>
{
 final String data;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('View ${widget.data}'.toUpperCase()),
            ...
            Padding(
              ...
              child: InputDecorator(
                ...
                child: DropdownButtonHideUnderline( child:DropdownButton<String>(
                  ...
                  items: <String>['Select','New', 'Assigned', 'Closed', 'Pending', 'Rejected']
